...
export function Composer({ disabled, focusToken, defaultThinking, onSend }) {
  ...
  // Shown only while a file is being dragged over the window; a permanent
  // hint under the box is furniture.
  const hint = dropping ? "drop to attach" : "";
