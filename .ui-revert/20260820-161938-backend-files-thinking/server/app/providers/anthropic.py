...
class AnthropicProvider:
    ...
    async def stream(
        ...
        *,
        ...
        # The toggle asks for more or less deliberation, which on this API is
        # spelled as effort rather than as a reasoning channel. Turning it off
        # buys the low setting; leaving it alone keeps the configured default.
        effort = {True: "high", False: "low"}.get(think, _EFFORT)
